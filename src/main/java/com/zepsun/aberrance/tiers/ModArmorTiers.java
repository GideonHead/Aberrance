package com.zepsun.aberrance.tiers;
...
public enum ModArmorTiers implements ArmorMaterial {
    ...
    KYANITE("kyanite", 45, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
    ...
    ModArmorTiers(String name, int durablilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionTypeMap,
                          int enchantmentValue, SoundEvent soundEvent, float toughness, float knockbackRes, Supplier<Ingredient> repairMaterial) {
        this.name = name;
        this.durabilityMultiplier = durablilityMultiplier;
    ...
    public String getName() {
        return Aberrance.MOD_ID + ":" + this.name;
    }
