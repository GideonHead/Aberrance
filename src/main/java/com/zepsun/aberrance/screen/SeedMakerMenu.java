...
import com.zepsun.aberrance.block.entity.SeedMakerBlockEntity;
...
public class SeedMakerMenu extends AbstractContainerMenu {
    public final SeedMakerBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public SeedMakerMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    // CREDIT FOR THIS METHOD GOES TO: diesieben07 | https://github.com/diesieben07/SevenCommons
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.SEED_MAKER.get());
    }
